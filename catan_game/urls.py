...
urlpatterns = [
    ...
    path("play_knight_card/<str:room_name>", views.PlayKnightCard.as_view()),
    path("dice/<str:room_name>", views.DiceAPIView.as_view()),
    path("create_home/<str:room_name>", views.HomeCreateAPIView.as_view()),
    path("create_city/<str:room_name>", views.CityUpdateAPIView.as_view()),
    path("create_road/<str:room_name>", views.RoadCreateAPIView.as_view()),
    path("buy_development_card/<str:room_name>", views.BuyDevelopmentCard.as_view()),
